...
public class CartServiceImplV2 implements CartService {
	...
	/*
	 *  1. cartList와 scan 인스턴스 객체 변수를 선언 "만" 하고
	 *  생성은 하지 않는다.
	 *  
	 *  이렇게하면 생성되지 않은 
	 ...
	 *  
	 *  3. NullpointException을 방지 하기위하여
	 *  클래스의 생성자 method에 객체변수를 초기화 하는
	 *  코드를 반드시 추가해준다.
	 *  
	 *  즉
	 ...
	 *  CartServiceImplV2 cs = new CartServieImplV2();
	 *  
