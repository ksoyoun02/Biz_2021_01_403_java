...
public class MenuServiceImplV3 implements MenuService {
	...
	/*
	 * 메뉴를 보여주고 선택된 메뉴에 따라서 
	 * 카트에 추가, 삭제 하거나 리스트를 보여줘야 한다
	 * 이 기능을 MenuService에서 구현하는 것이 아니라
	 * selectMenu()를 호출된 곳에서 구현을 해야한다.
	 * 
	 * 호출한 곳에서 selectMenu()결과에 따라
	 * 기능을 수행하려면
	 * 사용자가 메뉴를 보고 선택을 했을 때 선택된
	 * 결과값을 호출한 곳에 return을 해줘야한다
	 * 
	 * 이렇게 설계를 변경하려면 method를 
	 * void type이 아닌 int나 String 등 다른 type으로 변경해야한다
	 * 클래스의 method를 변경하려면 
	 * interface 부터 변경하고, interface를 impl....한 모든 클래스를 다 변경 해야 한다.
	 * 
