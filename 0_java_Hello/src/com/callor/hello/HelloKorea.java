 ...
 * 2. javac를 사용하여 컴파일을 수행하여 Hello.class 를 만드는 과정에서
 *    javac가 아무런 의미없는 문장으로 인식하고 그냥 지나치는 부분
 *    
 *    
 * java class
 * - java 언어 문법에 맞도록 작성된 문서파일
 ...
 * 
 * - 두개이상의 단어를 조합할떄는 Camel Case(낙타등방식)로 한다
 * 
 */
public class HelloKorea {

	/*
	 * main() method라고 부른다. 클래스를 만들고 컴파일을 수행한 수 실행을 했을때 반드시 있어야 하는 명령문
	 *
	 * 
	 * 
	 */
	...
	// 명령문은 없는 것과 같다.
	// ; -> 한줄짜리 명령문
	// java에서 문제가 발생하는 상황 => error or exception이라고 표현
	...
	// Console 출력(명령)문
	/*
	 *  Console 출력문 ""(문자열 인용문 , Double Qute. Mark)
	 * - ""표시 내의 내용을 그대로 Comsole출력 ""로
	 * 묶인 내용을 '문자열, string'이라고 한다.
	 * 숫자 (정수,실수 등등)는 숫자 그대로 수학적으로 해석한다.
	 *
	 * 산술(연산)식
	 * 1. 숫자 산술식 : 수학의 4칙연산을 수행하고 결과를 출력
	 * 2. 문자열 산술식 : ""로 묶인 문자열을 + 연산하면 문자열을 연결하여 출력
	 *    문자열 산술식은 + 연산만 가능
	 * 3. 문자열 + 숫자 산술식
	 *    모든 숫자를 자동으로 문자열화 하여 문자열 산술식으로 바꾸어 연산하고
	 *    결과를 출력한다.
	 * 
	 * 
	 */
